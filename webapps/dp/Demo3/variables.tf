...
variable "db_script_path" {
  type        = string
  default     = "scripts/provision_db.sh"
}



variable "lb_script_path" {
  type        = string
  default     = "scripts/provision_lb.sh"
}
variable "mon_script_path" {
  type        = string
  default     = "scripts/provision_mon.sh"
}
variable "apl_script_path" {
  type        = string
  default     = "scripts/provision_apl_web.sh"
}
